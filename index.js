var s=class extends HTMLElement{constructor(){super();this._initialized=false;this.shadow=this.attachShadow({mode:"open"});}connectedCallback(){this._initialized||(this.render(),this._initialized=true);}cleanShadow(){for(;this.shadow.firstChild;)this.shadow.removeChild(this.shadow.firstChild);}injectStyles(t){let o=document.createElement("style");o.textContent=t,this.shadow.appendChild(o);}emit(t,o){this.dispatchEvent(new CustomEvent(t,{detail:o,bubbles:true,composed:true}));}getAttr(t,o=""){return this.getAttribute(t)||o}getAttrArray(t){let o=this.getAttribute(t)||null;if(o)try{return JSON.parse(o)}catch{return []}return []}hasAttr(t){return this.hasAttribute(t)&&this.getAttribute(t)!=="false"}};var c=class extends s{constructor(){super();}render(){this.injectStyles(this.getStyles());let e=document.createElement("div");e.className="application";let t=document.createElement("slot");t.name="header";let o=document.createElement("div");o.className="main-container";let n=document.createElement("slot");n.name="sidebar";let a=document.createElement("div");a.className="main-contents";let i=document.createElement("slot");a.appendChild(i),o.appendChild(n),o.appendChild(a),e.appendChild(t),e.appendChild(o),this.shadow.appendChild(e);}getStyles(){return `
    ...
    `}};customElements.define("ind-toggle-switch",u);export{c as IndApplication,m as IndButton,p as IndCard,h as IndHeader,g as IndSidebar,u as IndToggleSwitch,v as getIconByName,y as indIconCheck,E as indIconChevronLeft,k as indIconChevronRight,w as indIconClose,I as indIconDownload,z as indIconEdit,x as indIconMinus,f as indIconPlus,C as indIconSearch,S as indIconTrash};//# sourceMappingURL=index.js.map
